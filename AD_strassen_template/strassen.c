                   ...
                   const size_t nrows, const size_t ncols)
{
    for(size_t i = 0; i < nrows; i++)
    {
        ...
        {
            C[i+row_start_C][j+col_start_C] = 
            A[i+row_start_A][j+col_start_A] - 
            B[i+row_start_B][j+col_start_B];
        }
    }
}
                   ...
                   const size_t row_start_C, const size_t col_start_C)
{
    ...
    strassen_aux(C, A, B, row_start_A, col_start_A, row_start_B, col_start_B, row_start_C, col_start_C, npivot); 
    
    strassen_aux_generalized(D, A, B, 
    ...
    strassen_aux_generalized(C, A, B, 
...
void strassen_matrix_multiplication(float **C, 
                                    float const *const *const A,
                                    float const *const *const B, 
